...
<div class="wrap_header fixed-header2 trans-0-4">
	...
	<div class="header-icons">
		<a title="ورود به حوله ارس" href="{{route('login')}}" class="header-wrapicon1 dis-block">
			...
			<img src="/svg/logged_user.svg" class="header-icon1" alt="ورود به حوله ارس" title="ورود به حوله ارس" width="28" >
				@else
				<img src="/svg/user.svg" class="header-icon1" alt="ورود به حوله ارس" title="ورود به حوله ارس" width="28" >
			@endif
		</a>
		...
		<div class="btn-show-menu">
			<div class="header-icons-mobile">
                ...
                <div class="header-wrapicon2" >
					...
					<img src="/svg/cart.svg" style="height: 28px" alt="سبد خرید" class="opencart" style="visibility:hidden">
