...
<style> .displaynone{display:none}.modal{display:none;position:fixed;z-index:1000;top:0;left:0;height:100%;width:100%;background:rgba(255,255,255,1) 50% 50% no-repeat}body.loading .modal{overflow:hidden;display:block}.newprice{display:inline-block;direction:rtl;color:purple}.line-through{text-decoration:line-through!important;display:inline-block;direction:rtl}figcaption{font-family:Montserrat-Regular;text-align:center;font-size:15px}a{font-family:Montserrat-Regular}.select2-dropdown--below{z-index:999999999!important}.select2-search--dropdown{display:none!important}.select2-container--default .select2-selection--single .select2-selection__arrow{top:14px!important}.select2-results__option{text-align:center!important;direction:unset} </style>
