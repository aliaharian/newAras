...
<html lang="fa">
<head>
    <title>المنشفة ارس - مناشف الترویجیة</title>

    <meta name="description" content="نحن نمتلك إمكانيات واسعة وأحدث التكنولوجيا العالمية المستخدمة في رسم الالشعارات والتصاميم التي ترغبون بها على المناشف، ونقدم خدمات متخصصة في هذا المجال. وجدير بالذكر أن مناشفنننا الدعائية تتوفر بمقاسات، تصاميم وألوان مختلفة وهي منافسة لأفضل المناشف الأجنبية.
">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 p-b-2">
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel" style="margin-top: 51px;">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            @foreach($template as $temp)
                                ...
                                @if($temp->place=='promotionalImage')
                            <img src="/files/promotional/detailpromo.jpg" data-toggle="modal" data-target="#myModal"
                    ...
                    <div  style="margin-bottom: 25px">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img  src="/images/goldoozi.jpg" class="image" style="width:100%;margin-top: 82px;">
                                <div class="middle" data-toggle="modal" data-target="#myModalgol" style="cursor: pointer;">
                                    <div class="text">مناشف ترويجية مع تطريز </div>
                                </div>
                            </div>
            ...
            <div class="col-md-8 p-b-2">
                ...
                <p>
                    عرضنا الخاص للهدايا الترويجية الخاصة بك:
                </p>
                    <p>
                        مناشف أرس مع أوسع وأحدث التقنيات المتوفرة في العالم ، توفر أفضل خدمات الترویجیة لکم.
                    </p>

                                    <p>
                        حکایة شعارك وعلامتك التجاریة علي المناشف هي ضمن تخصصنا.
                    </p>

                                    <p>
                        مناشفنا الترويجية تتنافس في مجموعة متنوعة من التصاميم والألوان وملفتة للنظر مع أفضل المناشف الأجنبية.
                    </p>

                                    <p>
                        يتم تقديم أنواع المناشف الترويجية لدينا بأفضل جودة وفي الشكل التالي:
                    </p>

                                    <p>
                        - المناشف الترويجية ذات نسيج الشعار على حافة المنشفة و سطح المنشفة
                    </p>

                                    <p>
                        المناشف الترويجية مع نسيج الشعارعلى الحافة فقط أو على سطح المنشفة فقط
                    </p>

                                    <p>
                        المناشف الترويجية مع الطباعة التفاعلية(راکتیو)
                    </p>

                                    <p>
                        - مناشف ترويجية مع تطريز ، خاصةً للطلبات القلیلة
                    </p>

                                    <p>
                        تجدر الإشارة بهدف تلبیة تنوع الأذواق یکون الجنس وملمس مناشف أرس وخیاطتها متنوعة وتقدم في شكل التالي:
                    </p>

                                    <p>
                        المناشف غزل(خیوط) طرفین (الغير مخملية )كلا الجانبين من منشفة لها نفس الشكل
                    </p>
        ...
        @foreach($products as $product)
                        ...
                        <div class="modal fade" id="myModal{{$product->id}}" role="dialog" style="z-index: 999999">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content" style="width: 565px;">
                                    ...
                                    <div class="modal-body">
                                        <img alt="{{$product->english_name}}" src="{{$product->image}}" style="width: 100%">
                                    </div>
            ...
            <div class="col-md-4 getheight">
                <div  style="margin-bottom: 25px">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img  src="{{$product->image}}" alt="{{$product->arabic_name}}" class="image" style="width:100%;">
                            <div class="middle" data-toggle="modal" data-target="#myModal{{$product->id}}" style="cursor: pointer;">
                                <div class="text">{{$product->arabic_name}}</div>
                            </div>
                        </div>
