...
<section class="bgwhite p-t-40 p-b-38">
            ...
            <div class="col-md-9 text-right">
                @if($invoice!=null)
                    ...
                    <div class="c-profile-order">
                        <section
                            class="c-profile-order-steps has-note swiper-container js-profile-order-steps swiper-container-horizontal swiper-container-rtl">
                            <div class="c-profile-order-steps__container swiper-wrapper"
                                 style="transition-duration: 0ms;">
                                <div
                                    class="c-profile-order-steps__item swiper-slide @if($invoice->status=='در صف بررسی') is-active @endif"
                                    style="width: 252.5px;">
                                    <img data-src="https://statics.arastowel.com/images/ordering.png"
                                         src="https://statics.arastowel.com/images/ordering.png">
                                    <span>در صف بررسی</span>
                                </div>
                                <hr>
                                <div
                                    class="c-profile-order-steps__item swiper-slide  @if($invoice->status=='تایید سفارش') is-active @endif"
                                    style="width: 252.5px;">
                                    <img data-src="https://statics.arastowel.com/images/list.png"
                                         src="https://statics.arastowel.com/images/list.png">
                                    <span>تایید سفارش</span>
                                </div>
                                <hr class="">
                                <div
                                    class="c-profile-order-steps__item swiper-slide swiper-slide-prev @if($invoice->status=='آماده سازی سفارش') is-active @endif"
                                    style="width: 252.5px;">
                                    <img data-src="https://statics.arastowel.com/images/barbari.png"
                                         src="https://statics.arastowel.com/images/barbari.png">
                                    <span>آماده‌سازی سفارش</span>
                                </div>
                                <hr class="">
                                <div
                                    class="c-profile-order-steps__item swiper-slide @if($invoice->status=='تحویل به مامور ارسال') is-active @endif"
                                    style="width: 252.5px;">
                                    <img data-src="https://statics.arastowel.com/images/motor_cycle.png"
                                         src="https://statics.arastowel.com/images/mororcycle.png">
                                    <span>تحویل به مامور ارسال</span>
                                </div>
                                <hr class="">
                                <div
                                    class="c-profile-order-steps__item swiper-slide @if($invoice->status=='تحویل مرسوله به مشتری') is-active @endif"
                                    style="width: 252.5px;">
                                    <img data-src="https://statics.arastowel.com/images/pack.png"
                                         src="https://statics.arastowel.com/images/pack.png">
                                    <span>تحویل مرسوله به مشتری</span>
                                </div>
                            </div>
                            <div
                                class="c-profile-order-steps__button c-profile-order-steps__button--next swiper-button-disabled">
                        ...
                        <div class="c-table-draught">
                            ...
                            <div class="c-table-draught__row">
                                <div class="c-table-draught__col">نحوه ارسال سفارش: تحویل توسط حوله ارس (ارسال رایگان
                                    سفارش‌های بالاتر از ۵۰۰ هزار تومان)
                                </div>
                            ...
                            <div class="c-table-draught__row">
                                <div class="c-table-draught__col c-table-draught__col--total">مبلغ این
                                    مرسوله:
                                    : {{number_format($invoice->transaction_amount)}} تومان
                        ...
                        <div class="c-table-order">
                            ...
                            <div class="c-table-order__body">
                                @foreach($invoice_line_items as $item)
                                    <div class="c-table-order__row">
                                        <div
                                            class="c-table-order__cell c-table-order__cell--number">{{$item->product_id}}</div>
                                        <div class="c-table-order__cell c-table-order__cell--product-name">
                                            <div class="c-table-order__product">
                                                <figure style="float: right">
                                                    <a href="{{route('shop.product',['product_id' => $item->product_id, 'product_name'=>str_replace(' ','-',\App\Product::find($item->product_id)->name)])}}"
                                                       class="">
                                                        <img width="100px"
    ...
    margin-right: 10px;">
                                        ...
                                        <div
                                            class="c-table-order__cell c-table-order__cell--price-value">{{number_format($item->price)}}
                                            تومان
                                        </div>
                                        <div
                                            class="c-table-order__cell c-table-order__cell--price-total">{{number_format($item->price*$item->qty)}}
                                            تومان
                                        </div>
                                        <div
                                            class="c-table-order__cell c-table-order__cell--discount">{{$item->off_percent}}
                                            ٪
                                        </div>
                                        <div
                                            class="c-table-order__cell c-table-order__cell--price-final">{{number_format($item->off_price*$item->qty)}}
                                            تومان
                                        </div>
