        ...
        <div class="col-md-4">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <form role="form" action="{{route('instagramPosts.update',['instagramPost'=>$fPost->id])}}" method="POST">
                @csrf
                @method('put')
                <div class="box-body">
                   <div class="input-group" style="width: 100%;padding: 10px">
                        <div id="picture" style="width: 100%;margin: 5px auto;"><img src="{{$fPost->image}}" style="width: 100%;margin: 5px auto;"></div>
                        ...
                        <input  type="text" hidden name="mainImage" style="width: 100%;height: 100%" value="{{$fPost->image}}" id="featured_image" placeholder="آدرس تصویر" readonly  />
              </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">لینک پست اینستاگرام</label>
                    <input type="text" value="{{$fPost->link}}" class="form-control" required name="link" placeholder="لینک پست اینستاگرام">
                  </div>
                </div>
                 <div class="form-group">
                    <div class="box-body no-padding">
                          ...
                          <li>
                            <a>آماده فروش؟
                              <div class="material-switch pull-left">
                                <input name="for_sale" id="for_sale" type="checkbox" class="categories" @if($fPost->for_sale==1) checked @endif/>
