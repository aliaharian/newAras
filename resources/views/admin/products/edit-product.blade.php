...
<html>
<head>
    <title>ویرایش محصول | حوله ارس</title>
                                            ...
                                            <li>
                                                <a>{{$category->name}}
                                                    <div class="material-switch pull-left">
                                                        <input name="cat{{$category->id}}" id="cat{{$category->id}}"
                                                               @if($product->hasCategory($category->id)) checked
                                                               @endif type="checkbox" class="categories"/>
                        ...
                        <div class="box box-solid">
                            ...
                            <div class="box-body no-padding">
                                <div class="input-group gallery-box" id="gallery-box" style="display: block;">
                                    ...
                                    @endforeach
                                    <a href="/roza-admin/elfinder/popup/gallery1" class="col-sm-4 add-gallery"
                                       id="gallery1"> @if(isset($galleryArray[0])) <img src="{{$galleryArray[0]}}"
                                                                                        style="width: 100%;height:100%">
                                        <span class="deletegaler" id="deletegallery8"
                                              onclick="deleteGallery1Image()">X</span> @else + @endif </a>
                                    <input hidden type="text" style="width: 100%;height: 100%" id="featured_image1"
                                           @if(isset($galleryArray[0])) value="{{$galleryArray[0]}}"
                                           @endif placeholder="آدرس تصویر" readonly name="gallery1"/>
                                    <a href="/roza-admin/elfinder/popup/gallery2" class="col-sm-4 add-gallery"
                                       id="gallery2"> @if(isset($galleryArray[1])) <img src="{{$galleryArray[1]}}"
                                                                                        style="width: 100%;height:100%">
                                        <span class="deletegaler " id="deletegallery8"
                                              onclick="deleteGallery2Image()">X</span> @else + @endif  </a>
                                    ...
                                    <a href="/roza-admin/elfinder/popup/gallery3" class="col-sm-4 add-gallery"
                                       id="gallery3"> @if(isset($galleryArray[2])) <img src="{{$galleryArray[2]}}"
                                                                                        style="width: 100%;height:100%">
                                        <span class="deletegaler " id="deletegallery8"
                                              onclick="deleteGallery3Image()">X</span> @else + @endif  </a>
                                    ...
                                    <a href="/roza-admin/elfinder/popup/gallery4" class="col-sm-4 add-gallery"
                                       id="gallery4"> @if(isset($galleryArray[3])) <img src="{{$galleryArray[3]}}"
                                                                                        style="width: 100%;height:100%">
                                        <span class="deletegaler " id="deletegallery8"
                                              onclick="deleteGallery4Image()">X</span> @else + @endif  </a>
                                    ...
                                    <a href="/roza-admin/elfinder/popup/gallery5" class="col-sm-4 add-gallery"
                                       id="gallery5"> @if(isset($galleryArray[4])) <img src="{{$galleryArray[4]}}"
                                                                                        style="width: 100%;height:100%">
                                        <span class="deletegaler " id="deletegallery8"
                                              onclick="deleteGallery5Image()">X</span> @else + @endif  </a>
                                    ...
                                    <a href="/roza-admin/elfinder/popup/gallery6" class="col-sm-4 add-gallery"
                                       id="gallery6"> @if(isset($galleryArray[5])) <img src="{{$galleryArray[5]}}"
                                                                                        style="width: 100%;height:100%">
                                        <span class="deletegaler " id="deletegallery8"
                                              onclick="deleteGallery6Image()">X</span> @else + @endif  </a>
                                    ...
                                    <a href="/roza-admin/elfinder/popup/gallery7" class="col-sm-4 add-gallery"
                                       id="gallery7"> @if(isset($galleryArray[6])) <img src="{{$galleryArray[6]}}"
                                                                                        style="width: 100%;height:100%">
                                        <span class="deletegaler " id="deletegallery8"
                                              onclick="deleteGallery7Image()">X</span> @else + @endif  </a>
                                    ...
                                    <a href="/roza-admin/elfinder/popup/gallery8" class="col-sm-4 add-gallery"
                                       id="gallery8"> @if(isset($galleryArray[7])) <img src="{{$galleryArray[7]}}"
                                                                                        style="width: 100%;height:100%">
                                        <span class="deletegaler " id="deletegallery8"
                                              onclick="deleteGallery8Image()">X</span> @else + @endif  </a>
                                    ...
                                    <a href="/roza-admin/elfinder/popup/gallery9" class="col-sm-4 add-gallery"
                                       id="gallery9"> @if(isset($galleryArray[8])) <img src="{{$galleryArray[8]}}"
                                                                                        style="width: 100%;height:100%">
                                        <span class="deletegaler " id="deletegallery8"
                                              onclick="deleteGallery9Image()">X</span> @else + @endif  </a>
...
{{--                                           placeholder="Product name" value="{{$product->english_name}}">--}}
{{--                                </div>--}}

{{--                                <div class="form-group">--}}
{{--                                    <input class="form-control" name="arabic_title" id="arabic_title"--}}
{{--                                           placeholder="اسم المنتج" value="{{$product->arabic_name}}">--}}
{{--                                </div>--}}
                            ...
                            <div class="box-body">
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#tab_1" id="pricetab" data-toggle="tab">قیمت</a>
                                        </li>
                                        <li><a href="#tab_2" id="colorstab" class="hidden" data-toggle="tab">رنگ ها</a>
                                        </li>
                                        <li><a href="#tab_3" id="sizetab" class="hidden" data-toggle="tab">سایز ها</a>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab_1">
                                            <div class="input-group">
                                                ...
                                                <input type="number" id="mainprice" name="mainprice" pattern="[0-9]*"
                                                       onkeypress="return validatenumericsnum(event);"
                                                       class="form-control" value="{{$product->price}}"
                                                       placeholder="قیمت اصلی به تومان">
                                            </div>

                                            <div class="input-group">
                                                <span class="input-group-addon">موجودی انبار</span>
                                                <input type="number" id="mainqty" name="mainqty" pattern="[0-9]*"
                                                       onkeypress="return validatenumericsnum(event);"
                                            ...
                                            <div class="input-group" style="height: 50px">
                                                ...
                                                <div class="material-switch pull-right" style="margin-top: 15px">
                                                    <input name="colorvariable" id="colorvariable" type="checkbox"
                                                           @if($product->variable!=0) checked
                                                           @endif onclick="colorVariable()" class="colorvariable"/>
                                            ...
                                            <div class="input-group" style="height: 50px">
                                                ...
                                                <div class="material-switch pull-right" style="margin-top: 15px">
                                                    <input name="sizevariable" id="sizevariable"
                                                           onclick="sizeVariable()" @if($product->variable==2) checked
                                                           @endif type="checkbox" class="sizevariable"/>
                                            ...
                                            <div class="input-group" style="height: 50px">
                                                ...
                                                <div class="material-switch pull-right" style="margin-top: 15px">
                                                    <input name="off" id="off" type="checkbox" onclick="showOff()"
                                                           @if($product->off->count()!=0) checked
                                                           @endif class="offcheck"/>
                                            ...
                                            <div class="display-none" id="offDetails">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="offpercent" pattern="[0-9]*"
                                                           onkeypress="return validatenumericsnum(event);"
                                                           @if($product->off->count()!=0) @foreach($product->off as $off) @php $offpercent=$off->percent @endphp @endforeach value="{{$offpercent}}"
                                                           @endif class="form-control"
                                                           placeholder="درصد تخفیف بین ۱ تا ۱۰۰ درصد">
                                                </div>
                                                <div class="input-group" style="z-index: 999;">
                                                    <span class="input-group-addon">تاریخ شروع حراج</span>
                                                    <input type="text" id="tarikhstart" class="form-control pull-right"
                                                           style="z-index: 999999;">
                                                    <input hidden type="text" name="offstart" id="tarikhStartAlt"
                                                    ...
                                                    <input hidden type="text" name="offend" id="tarikhEndAlt"
                                                           class="form-control pull-right hidden">
                                                        ...
                                                        <div class="box-header with-border">
                                                            <h4 class="box-title">
                                                                <a data-toggle="collapse" data-parent="#accordion"
                                                                   id="titleColor{{$color->id}}"
                                                                   href="#collapse{{str_replace('#','',$color->english_name)}}">
                                                                    {{$color->name}}
                                                                </a>
                                                            </h4>
                                                            <div class="material-switch pull-left">
                                                                <input name="{{$color->id}}" id="{{$color->id}}"
                                                                       @if($product->hasColor($color->id)) checked
                                                                       @endif type="checkbox" class="colors"/>
                                                                <label for="{{$color->id}}"
                                                                       class="label-success"></label>
                                                            </div>

                                                            <div
                                                                id="collapse{{str_replace('#','',$color->english_name)}}"
                                                                class="panel-collapse collapse">
                                                                <div class="box-body color-box-body">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon"
                                                                              id="picture{{str_replace('#','',$color->english_name)}}">@if($product->hasColor($color->id))
                                                                                <a onclick="deleteImage('{{str_replace('#','',$color->english_name)}}')"><i
                                                                                        class="fa fa-times btn btn-danger btn-lg"></i></a>
                                                                                <img class="variableImage"
                                                                                     src="@foreach($selectedColors as $selectedColor) @if($selectedColor->product_id==$product->id && $selectedColor->color_id==$color->id){{$selectedColor->image}} @endif @endforeach"/>  @else
                                                                                تصویر @endif</span>
                                                                        <button type="button"
                                                                                class="browse btn btn-primary"
                                                                                id="imageUpload{{str_replace('#','',$color->english_name)}}">
                                                                            انتخاب تصویر
                                                                        </button>
                                                                        <input type="text"
                                                                               style="width: 100%;height: 100%"
                                                                               id="featured_image{{str_replace('#','',$color->english_name)}}"
                                                                               placeholder="آدرس تصویر"
                                                                               value="@foreach($selectedColors as $selectedColor) @if($selectedColor->product_id==$product->id && $selectedColor->color_id==$color->id){{$selectedColor->image}} @endif @endforeach"
                                                                               readonly
                                                                               name="imageColor{{$color->id}}"/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <!-- we are adding the .panel class so bootstrap.js collapse plugin detects it -->
                                                <div class="panel box box-primary">
                                                    <div class="box-header with-border">
                                                        <h4 class="box-title">
                                                            <a data-toggle="collapse" data-parent="#accordion"
                                                               id="titleSize{{$size->id}}"
                                                               href="#collapse{{$size->english_name}}">
                                                                {{$size->name}}
                                                            </a>
                                                        </h4>
                                                        <div class="material-switch pull-left">
                                                            <input name="Size{{$size->id}}" id="Size{{$size->id}}"
                                                                   @if($product->hasSize($size->id)) checked
                                                                   @endif type="checkbox" class="sizes"/>
                                                            <label for="Size{{$size->id}}"
                                                                   class="label-success"></label>
                                                        </div>

                                                        <div id="collapse{{$size->english_name}}"
                                                             class="panel-collapse collapse">
                                                            <div class="box-body size-box-body">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="number" pattern="[0-9]*"
                                                                           name="priceSize{{$size->id}}"
                                                                           id="priceSize{{$size->id}}"
                                                                           onkeypress="return validatenumericsnum(event);"
                                                                           @foreach($selectedSizes as $selectedSize) @if($selectedSize->product_id==$product->id && $selectedSize->size_id==$size->id) value="{{$selectedSize->price}}"
                                                                           @endif @endforeach class="form-control"
            ...
            {!!                     $product->info !!}
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    ...
                                    <label for="draft" type="button" class="btn btn-default"><i
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#imageUpload{{str_replace('#','',$color->english_name)}}').popupWindow({
            windowURL: '/roza-admin/elfinder/popup/{{str_replace('#','',$color->english_name)}}',
            windowName: 'Filebrowser',
            height: 490,
            width: 950,
            centerScreen: 1
