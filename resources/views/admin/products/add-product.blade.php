                                                ...
                                                <a>{{$category->name}}
                                                    <div class="material-switch pull-left">
                                                        <input name="cat{{$category->id}}" id="cat{{$category->id}}"
                                                               type="checkbox" class="categories"/>
                                        ...
                                        <div class="tab-pane active" id="tab_1">
                                            <div class="input-group">
                                                ...
                                                <input type="number" id="mainprice" name="mainprice" pattern="[0-9]*"
                                                       ...
                                                       class="form-control" placeholder="قیمت اصلی به تومان">
                                            </div>
                                            ...
                                            <div class="input-group" style="height: 50px">
                                                ...
                                                <div class="material-switch pull-right" style="margin-top: 15px">
                                                    <input name="colorvariable" id="colorvariable" type="checkbox"
                                                           onclick="colorVariable()" class="colorvariable"/>
                                            ...
                                            <div class="input-group" style="height: 50px">
                                                ...
                                                <div class="material-switch pull-right" style="margin-top: 15px">
                                                    <input name="sizevariable" id="sizevariable"
                                                           onclick="sizeVariable()" type="checkbox"
                                                           class="sizevariable"/>
                                                                ...
                                                                <div class="box-body color-box-body">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon"
                                                                              id="picture{{str_replace('#','',$color->english_name)}}">تصویر</span>
                                                                        <button type="button"
...
<p><img alt="" src="https://arastowel.com/files/icons/2000px-Waschen_40.svg.png" />&nbsp; &nbsp;شستشو با ماشین یا دست حداکثر تا ۴۰ درجه</p>

<p><img alt="" src="https://arastowel.com/files/icons/gin-sym-pro-dry-not.jpg" />&nbsp;&nbsp; خشکشویی نکنید</p>

<p><img alt="" src="https://arastowel.com/files/icons/Do-not-use-bleach-icon-300x235.png" />&nbsp; &nbsp;از سفید کننده استفاده نکنید</p>

<p><img alt="" src="https://arastowel.com/files/icons/88742-200.png" />&nbsp; &nbsp;می توانید از خشک کن استفاده کنید</p>
