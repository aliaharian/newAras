...
<html>
<head>
  <title>ویرایش نوشته | حوله ارس</title>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" name="english_title" id="english_title" value="{{$blog->english_title}}" placeholder="Article title">
              </div>
              <div class="form-group">
                    <textarea id="ckeditor2" name="ckeditor2" class="form-control" style="height: 300px">
                      {!! $blog->english_content !!}
                    </textarea>
              </div>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" name="arabic_title" id="arabic_title" value="{{$blog->arabic_title}}" placeholder="عنوان المقال">
              </div>
              <div class="form-group">
