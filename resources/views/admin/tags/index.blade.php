              ...
              <form role="form" action="{{route('tags.store')}}" method="POST">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" required id="tag_english_name" name="tag_english_name" placeholder="tag name">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">اسم العلامة</label>
                    <input type="text" class="form-control" required id="tag_arabic_name" name="tag_arabic_name" placeholder="اسم العلامة">
                  </div>
                </div>
                <!-- /.box-body -->
