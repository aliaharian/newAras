              ...
              <form role="form" action="{{route('gifts.store')}}" method="POST">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" required name="percent" placeholder="درصد تخفیف">
                  </div>
                </div>
                <!-- /.box-body -->
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name">@if($gift->used==1)<span style="color: darkred">استفاده شده</span>@else استفاده نشده @endif</td>
                    <td class="mailbox-name">{{\App\User::find($gift->user_id)->name}} {{\App\User::find($gift->user_id)->last_name}} </td>
                    <td class="mailbox-name">@if($gift->invoice_id!='')<a href="{{route('invoices.show',['invoice' => $gift->invoice_id])}}" class="btn btn-info">{{$gift->invoice_id}}</a>@endif</td>
