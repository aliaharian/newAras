...
<html>
<head>
  <title> حوله های خاص | حوله ارس</title>
...
{{--                  <div class="form-group">--}}
{{--                    <label for="exampleInputEmail1">towel name</label>--}}
{{--                    <input type="text" class="form-control" required id="towel_english_name" value="{{$selectedtowel->english_name}}" name="towel_english_name" placeholder="towel name">--}}
{{--                  </div>--}}

{{--                  <div class="form-group">--}}
{{--                    <label for="exampleInputEmail1">اسم منشفة</label>--}}
{{--                    <input type="text" class="form-control" required id="towel_arabic_name" value="{{$selectedtowel->arabic_name}}" name="towel_arabic_name" placeholder="اسم منشفة">--}}
{{--                  </div>--}}
...
{{--                      @if($selectedtowel->logo!=null)--}}
{{--                        <a onclick="deletemainImage2()">--}}
{{--                          <i class="fa fa-times btn btn-danger btn-lg"></i>--}}
{{--                        </a><img style="width: 50%" src="{{$selectedtowel->logo}}" />--}}
{{--                      @endif--}}
{{--                    </div>--}}
{{--                    <button type="button" class="browse btn btn-primary" id="imageUpload2" style="width: 100%;padding: 10px;margin: auto" > انتخاب تصویر لوگو </button>--}}
{{--                    <input  type="text" value="{{$selectedtowel->logo}}" hidden name="mainImage2" style="width: 100%;height: 100%" id="featured_image2" placeholder="آدرس تصویر" readonly  />--}}
...
<script>
    ...
    $(document).ready(function(){
        ...
        window.callbackmain2=function (file){
            $('#picture2').html('<a onclick="deletemainImage2()"><i class="fa fa-times btn btn-danger btn-lg"></i></a><img style="width: 50%" src="' + file + '" /> ');
            $('#featured_image2').val(file);
        }
    });

    function deletemainImage2() {
        $('#picture2').html('');
        $('#featured_image2').val('');
    }
</script>
