...
{{--                    <input type="text" class="form-control" required id="towel_english_name" name="towel_english_name" placeholder="towel name">--}}
{{--                  </div>--}}

{{--                  <div class="form-group">--}}
{{--                    <label for="exampleInputEmail1">اسم منشفة</label>--}}
{{--                    <input type="text" class="form-control" required id="towel_arabic_name" name="towel_arabic_name" placeholder="اسم منشفة">--}}
{{--                  </div>--}}
...
{{--                  <div class="input-group" style="width: 100%;padding: 10px">--}}
{{--                    <div id="picture2" style="width: 100%;margin: 5px auto;"></div>--}}
{{--                    <button type="button" class="browse btn btn-primary" id="imageUpload2" style="width: 100%;padding: 10px;margin: auto" > انتخاب لوگو حوله های تبلیغاتی </button>--}}
{{--                    <input  type="text" hidden name="mainImage2" style="width: 100%;height: 100%" id="featured_image2" placeholder="آدرس تصویر" readonly  />--}}
{{--                  </div>--}}
