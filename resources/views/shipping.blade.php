    ...
    <main id="main">
                                    ...
                                    @foreach($addresses as $address)
                                        <div id="address-section">
                                            <div class="c-checkout-contact is-completed js-user-address-container"
                                                ...
                                                <div class="c-checkout-contact__content js-default-recipient-box">
                                                    <ul class="c-checkout-contact__items">
                                                        ...
                                                        <li class="c-checkout-contact__item c-checkout-contact__item--location ">
                                                            ...
                                                            <br>
                                                            استان
                                                            <span>{{\App\Province::where('id',$address->province_id)->value('name')}}</span>
                                                            ، شهرستان
                                                ...
                                                <a href="{{route('profile.address.edit')}}"
                                                   class="c-checkout-contact__location" id="change-address-btn">تغییر
                                                    آدرس
                                                    ارسال</a>
                                            </div>
                                        ...
                                        <ul class="c-checkout-paymethod m-b-20">
                                            <li data-event="change_payment_method">
                                                <div
                                                    class="c-checkout-paymethod__item has-options js-checkout-paymethod__item is-selected is-select-mode">
                                                ...
                                                <div class="c-checkout-paymethod__options">
                                                    <div class="c-checkout-paymethod__providers">
                                                        ...
                                                        <span class="c-ui-radio__check"></span>
                                                            ...
                                                            <img
                                                                src="https://www.sizpay.ir/images/blog/2473/%D8%B3%D9%BE%D9%87%D8%B1.1.webp">
                                                        </label>
                                                    </div>
                                                </div>
                                            </li>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a class="c-product-box__img js-url">
                                                                                <img
                                                                                    alt="{{\App\Product::find($order->product_id)->name}}"
		...
		{{number_format($total_price)}}تومان
                                                        ...
                                                        @if($gift->count()==1)
                                                            ...
                                                            {{number_format($total_price*($gift->value('percent'))/100)}}
                                                                تومان
			                                            </span>
                                                            </li>
                                                        @endif
                                                    ...
                                                    <span>
                                                        @if($shippingPrice==0)
                                                            <span>رایگان</span>
                                                        @else
                                                            <span>{{number_format($shippingPrice)}} </span> تومان</span><span
                                                                    class="hidden"> + </span>
                                            ...
                                            <div class="c-checkout-summary__content">
                                                ...
                                                <span class="c-checkout-summary__price-value-amount"
                                                    ...
                                                    <span>
                                                     @if($gift->count()==0)
                                                            @if($shippingPrice==0)
                                                                <span>{{number_format($total_price)}} </span> </span><span
                                                        class="hidden"> + </span>
                                                    @else
                                                        <span>{{number_format($total_price+$shippingPrice)}} </span> </span><span
                                                        class="hidden"> + </span>
                                                    ...
                                                    @else
                                                        ...
                                                        @if($shippingPrice==0)
                                                            <span>{{number_format($total_price*(100-$gift->value('percent'))/100)}} </span> </span>
                                                        @else
                                                            <span>{{number_format(($total_price*(100-$gift->value('percent'))/100)+$shippingPrice)}} </span> </span>
